...
(function($) {
    $(document).ready(function() {
        ...
        $('.jquery_popup_2').popup({
                    content: $('.b-jquery-popup_2')
                });
        $('.jquery_popup_3').popup({
                            content: $('.b-jquery-popup_3')
                        });
        $('.jquery_popup_help').popup({
                                    content: $('.b-jquery-popup_help')
                                });
        ...
        //------------------------------- events, places js -----------------------------//
            ...
            //------------------------------- single event js -----------------------------//
                ...
                if ($('.b-event-counter__item').hasClass('f-time')) {
                    ...
                    var firstDate = new Date("Jul 31, 2017 12:45:00");
